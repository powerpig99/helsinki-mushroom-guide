...
function parseMarkdown(md) {
  ...
  html = html.replace(/\[([^\]]+)\]\(([^)]+)\)/g, (match, text, url) => {
    // If URL points to .md, point to .html
    let targetUrl = url;
...
const chapters = [
  { file: '01_legal_and_ethics.md', title: '01. Legal Rights, Nature Protection & Forest Safety', icon: '⚖️' },
  { file: '02_helsinki_transit_spots_guide.md', title: '02. Helsinki Foraging Spots by HSL Transit', icon: '🚌' },
  { file: '03_seasonal_calendar_and_habitats.md', title: '03. Seasonal Calendar & Forest Ecology', icon: '📅' },
  { file: '04_deadly_and_toxic_species.md', title: '04. Deadly & Toxic Species Survival Manual', icon: '☠️' },
...
<head>
  ...
  <title>${ch.title} | Helsinki Mushroom Guide</title>
...
<body>
  ...
  <header class="doc-sticky-header">
    <div class="doc-nav-left">
      <a href="../index.html" class="doc-btn-back">🍄 Mushroom Portal</a>
...
// Also generate overview.html from README.md
...
console.log('Done compiling all mushroom guide markdown files to HTML.');
