...
const I18N = {
  ...
  ui: {
    en: {
      ...
      portalSafetyTitle: "Forest Safety, Legal Rights & Deadly Species Survival Manual",
      ...
      portalLookalikesTitle: "In-Depth Lookalikes & Deadly Toxins Manual in Chapter 04",
      ...
      lookalikesTitle: "Lookalikes & Pitfalls to Pay Attention to",
      ...
      inaturalistTitle: "iNaturalist: Community Science & Mushroom Identification",
      inaturalistDesc: "As recommended by Aaron Hilliard in the beginner foraging video, iNaturalist is the gold-standard mobile companion to log fungal sightings, utilize AI vision suggestions, and receive Research-Grade identification confirmations from professional mycologists.",
      inaturalistInstallGuide: "Installation & Field Setup Guide",
      step1Install: "Install App: Download free on iOS App Store or Android Google Play, or visit inaturalist.org.",
      step2Account: "Create Account: Register with your email to sync observations across devices and connect with Finnish mycology specialists.",
      step3Permissions: "Enable Location & Camera: High-accuracy GPS coordinates are vital for Finnish biodiversity mapping and remembering your foraging trails.",
      step4PhotoProtocol: "Field Photography Protocol: Always capture 3–4 diagnostic angles: (1) Cap in-situ with partner trees, (2) Underside gills/ridges/pores/spines, (3) Intact stem base (never trim before photographing; inspect for volva/ring), (4) Longitudinal flesh cross-section.",
      inaturalistWarning: "AI Suggestion ≠ Edibility Guarantee: Computer vision suggestions are scientific hypotheses. Never consume any wild mushroom based solely on an app recommendation. Always verify macroscopic anatomy with 100% certainty.",
      appStoreIos: "App Store (iOS)",
      playStoreAndroid: "Google Play (Android)",
      ...
      offlineBtnClearCache: "Clear Cached Photos",
    ...
    zh: {
      ...
      portalSafetyTitle: "森林法规、自然公共权与生死避险手册详见典籍第01 & 04章",
      ...
      portalLookalikesTitle: "极度危险混淆种与毒理机制详见典籍第04章",
      ...
      channelLabel: "油管频道",
      inaturalistTitle: "iNaturalist：全球公民科学与野真菌智能鉴别应用",
      inaturalistDesc: "在入门野采视频中被真菌学教育家 Aaron Hilliard 重点推荐的必备神器。结合前沿计算机视觉 AI 与全球/芬兰本土真菌学家的社区同行评审，帮你记录林间发现并获得专业科研级鉴定。",
      inaturalistInstallGuide: "安装配置与野外实操指南",
      step1Install: "下载安装：在苹果 App Store 或安卓 Google Play 搜索“iNaturalist”免费下载，或访问官网 inaturalist.org。",
      step2Account: "注册账号：使用邮箱免费注册，实现跨设备同步并与芬兰及全球真菌学专家交流。",
      step3Permissions: "授予权限：开启相机与“使用期间”精确位置权限，拍照时自动记录森林经纬度，便于科研与记录采菇秘密点位。",
      step4PhotoProtocol: "野真菌科学拍照法则：拍摄4张关键细节：① 菌盖全貌与生境共生树种；② 菌盖腹面（菌褶/假褶/菌管/肉刺）；③ 菌柄完整基部（切勿拍前切根！务必拍摄是否有菌托或菌环）；④ 纵向剖面（观察变色与中空结构）。",
      inaturalistWarning: "核心防毒法则：AI 识别建议仅是科研参考假设，绝非食用通行证！入口前必须根据实体图鉴进行100%宏观解剖特征查验。",
      appStoreIos: "苹果 App Store (iOS)",
      playStoreAndroid: "安卓 Google Play",
      ...
      portalSafetyTitle: "Jokamiehenoikeudet ja myrkkysienten selviytymisopas luvuissa 01 & 04",
      ...
      portalLookalikesTitle: "Vaaralliset näköislajit ja toksiinit luvussa 04",
      ...
      searchTacticsTitle: "Etsintävinkit ja maastotaktiikka",
      lookalikesTitle: "Näköislajit ja vaaranpaikat",
      ...
      channelLabel: "Kanava",
      inaturalistTitle: "iNaturalist: Kansalaistiede ja lajitunnistus maastossa",
      inaturalistDesc: "Aaron Hilliardin alkeisvideossa suosittelema maailman johtava luontosovellus. Yhdistää tekoälypohjaisen kuvantunnistuksen ja asiantuntijoiden vertaisarvioinnin lajihavainnoillesi.",
      inaturalistInstallGuide: "Asennus- ja maasto-opas",
      step1Install: "Lataa sovellus: Hae maksutta iOS App Storesta tai Google Playsta, tai käytä verkossa osoitteessa inaturalist.org.",
      step2Account: "Luo käyttäjätili: Rekisteröidy sähköpostilla tallentaaksesi havaintosi ja saadaksesi vahvistuksia suomalaisilta sienituntijoilta.",
      step3Permissions: "Salli sijainti ja kamera: Tarkat GPS-koordinaatit tallentuvat havaintoihin, jolloin muistat omat sienipaikkasi ja tuet lajitutkimusta.",
      step4PhotoProtocol: "Sienivalokuvauksen säännöt: Ota 3–4 kuvaa: (1) Lakin yläpinta ja kasvuympäristö (lähimmät puut), (2) Alapinta (heltat, poimut tai pillit), (3) Jalan tyvi kokonaisena (älä leikkaa ennen kuvausta!), (4) Halkaisupinta.",
      inaturalistWarning: "Tärkeä turvasääntö: Sovelluksen tekoälyehdotus ei ole syömäkelpoisuustakuu. Älä koskaan syö sientä pelkän sovelluksen perusteella – varmista laji aina 100 % varmuudella.",
      appStoreIos: "App Store (iOS)",
      playStoreAndroid: "Google Play (Android)",
      ...
      offlineBtnClearCache: "Tyhjennä tallennetut kuvat",
