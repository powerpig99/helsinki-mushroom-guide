...
const I18N = {
  ...
  ui: {
    en: {
      ...
      inaturalistWarning: "⚠️ AI Suggestion ≠ Edibility Guarantee: Computer vision suggestions are scientific hypotheses. Never consume any wild mushroom based solely on an app recommendation. Always verify macroscopic anatomy with 100% certainty.",
    ...
    zh: {
      ...
      inaturalistWarning: "⚠️ 核心防毒法则：AI 识别建议仅是科研参考假设，绝非食用通行证！入口前必须根据实体图鉴进行100%宏观解剖特征查验。",
      ...
      inaturalistWarning: "⚠️ Tärkeä turvasääntö: Sovelluksen tekoälyehdotus ei ole syömäkelpoisuustakuu. Älä koskaan syö sientä pelkän sovelluksen perusteella – varmista laji aina 100 % varmuudella.",
      appStoreIos: "🍏 App Store (iOS)",
      playStoreAndroid: "🤖 Google Play (Android)",
