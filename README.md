...
| **08** | [**Master Index: 50+ Wild Edible Mushrooms of Finland**](https://powerpig99.github.io/helsinki-mushroom-guide/docs/08_expanded_edible_species_index.html) ([Local HTML](docs/08_expanded_edible_species_index.html)) | [.md](docs/08_expanded_edible_species_index.md) | Comprehensive 54-species catalog, Finnish commercial species (*kauppasienet*), tree symbiosis, and edibility ratings. |
| **09** | [**Wild Reishi in Helsinki: Occurrence, Habitats, Trees & Lookalikes**](https://powerpig99.github.io/helsinki-mushroom-guide/docs/09_reishi_in_helsinki.html) ([Local HTML](docs/09_reishi_in_helsinki.html)) | [.md](docs/09_reishi_in_helsinki.md) | *Ganoderma lucidum* (*lakkakääpä*), coastal black alder swamp (*tervaleppäkorpi*), host tree diagnostics, lookalike defense vs *Fomitopsis pinicola*, video masterclasses. |
